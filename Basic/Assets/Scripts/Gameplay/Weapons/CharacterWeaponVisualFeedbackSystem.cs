...
namespace Unity.Template.CompetitiveActionMultiplayer
{
    ...
    public partial struct CharacterWeaponVisualFeedbackSystem : ISystem
    {
        ...
        {
            state.RequireForUpdate<BasicCharacterControl>();
        }
        ...
        public void OnUpdate(ref SystemState state)
        {
            CharacterWeaponVisualFeedbackJob job = new CharacterWeaponVisualFeedbackJob
            {
                ...
                MainEntityCameraLookup = SystemAPI.GetComponentLookup<MainEntityCamera>(),
            };
        ...
        public partial struct CharacterWeaponVisualFeedbackJob : IJobEntity
        {
            ...
            void Execute(ref CharacterWeaponVisualFeedback characterWeaponVisualFeedback, in BasicCharacterComponent character, in KinematicCharacterBody characterBody, in ActiveWeapon activeWeapon)
            {
